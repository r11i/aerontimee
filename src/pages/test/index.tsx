...
export default function Home() {
  ...
  const gateChanges = [
    { id: 1, old: 'A1', new: 'B2', changeTime: '2023-11-10T12:30:00' },
    { id: 2, old: 'B2', new: 'C3', changeTime: '2023-11-10T13:45:00' },
  ...
  return (
    <div>
      <Navbar image='/aerontimelogo.png' navbarStyles="box-border bg-black relative top-0 w-full px-[82px]" linkStyles="text-white flex items-center text-[24px]" />
