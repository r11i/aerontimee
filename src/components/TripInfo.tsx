...
const TripInfo: React.FC<TripInfoProps> = ({ tripInfo }) => {
  return (
      <div className='bg-[#2D2F3D] rounded-[20px] text-white py-[27px] px-[34px]'>
        <div className='border-solid border-green border-[1px] flex justify-between'>
                ...
                <div>
                    ...
                    <div className='flex items-center'>
                        <div className='mr-[45px]'>
                            {<Image src={airlineImageMap[tripInfo.airline]} alt={`${tripInfo.airline} Logo`} width={104} height={104} />}
                        </div>
                        <div>
                            <p>{tripInfo.airline}</p>
                            <p>{tripInfo.origin === 'Jakarta'
                                ? `${tripInfo.origin} - ${tripInfo.flightNumber}`
                                : `${tripInfo.destination} - ${tripInfo.flightNumber}`}
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className='flex items-center'>
                <div>
                    ...
                    <div className='flex mb-[9px] pl-[25%] border-solid border-[1px] border-black'>
                        <Image src="/baggage.png" alt='baggage' width={12} height={17}></Image>
                        <p className='ml-[8px] text-[14px] font-[400] border-solid border-[1px] border-black'>Baggage</p>
                    </div>
